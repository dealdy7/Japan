  ...
  `).join('');
            ...
            const botItems = [
                ...
                NAV.find(n => n.id === 'gems'),
                NAV.find(n => n.id === 'halal'),
                NAV.find(n => n.id === 'planning'),
                NAV.find(n => n.id === 'savings')
            ].filter(Boolean);
